...
export default function Home() {
  ...
  async function handleSave(details) {
    try {
      ...
      const response = await fetch("https://cabpool-backend.onrender.com/tickets/add", {
        method: "POST",
  ...
  async function handleJoin(ticketId) {
    try {
      ...
      const response = await fetch(`https://cabpool-backend.onrender.com/tickets/join/${ticketId}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function handleUnjoin(ticketId) {
    try {
      ...
      const response = await fetch(`https://cabpool-backend.onrender.com/tickets/unjoin/${ticketId}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  async function handleDelete(ticketId) {
    try {
      ...
      const response = await fetch(`https://cabpool-backend.onrender.com/tickets/delete/${ticketId}`, {
        method: "DELETE",
        headers: { "Content-Type": "application/json" },
  ...
  const handleComplete = async (ticketId) => {
    try {
      const response = await fetch(`https://cabpool-backend.onrender.com/tickets/complete/${ticketId}`, {
        method: "POST",
        headers: { "Content-Type": "application/json" }
      });
      const data = await response.json();

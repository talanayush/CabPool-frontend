...
export default function TicketInfo() {
  ...
  async function handleFareSubmit() {
    ...
    try {
      const response = await fetch(`https://cabpool-backend.onrender.com/tickets/updatefare/${ticket._id}`, {
        method: "PATCH",
  ...
  async function markRiderAsPaid(riderId, paidStatus) {
    ...
    try {
      const response = await fetch(`https://cabpool-backend.onrender.com/tickets/markPaid/${ticketId}/${riderId}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
